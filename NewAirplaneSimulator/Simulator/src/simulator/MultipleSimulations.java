...
public class MultipleSimulations 
{
	...
	static JTextField totalsimulationsInput = new JTextField("");
	...
	{	   
	    ...
	    {
			int totalSimulations = Integer.parseInt(totalsimulationsInput.getText());
			...
			int preBoardTime = 90;
			double currentBoardTime = preBoardTime;
			...
			//Return totalBoardTime for given boarding method
				...
				currentBoardTime = tempTime.calculateBoardTime(boardingMethod, passengerList, totalRows, totalColumns, currentBoardTime, moveToRow, moveToBack, windowSitTime, middleSitTime, aisleSitTime, debugSelection, plane, animationSelection);
				totalBoardTime = totalBoardTime + currentBoardTime;
			}
			
			//Convert totalBoardTime from seconds to minutes and round to two decimal places
			totalBoardTime = totalBoardTime / totalSimulations;
	...
	{ 
	    ...
	    inputPanel.add(new JLabel("Total Simulations"));
	    inputPanel.add(totalsimulationsInput);
